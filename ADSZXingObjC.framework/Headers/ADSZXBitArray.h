...
@class ADSZXByteArray, ADSZXIntArray;

/**
 * A simple, fast array of bits, represented compactly by an array of ints internally.
 */
@interface ADSZXBitArray : NSObject <NSCopying>
...
- (void)appendBitArray:(ADSZXBitArray *)other;

- (void)xor:(ADSZXBitArray *)other;
 ...
 */
- (void)toBytes:(int)bitOffset array:(ADSZXByteArray *)array offset:(int)offset numBytes:(int)numBytes;

/**
 * @return underlying array of ints. The first element holds the first 32 bits, and the least
 *         significant bit is bit 0.
 */
- (ADSZXIntArray *)bitArray;

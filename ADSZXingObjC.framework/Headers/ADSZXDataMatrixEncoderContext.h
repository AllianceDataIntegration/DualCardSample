...
@class ADSZXDataMatrixSymbolInfo, ADSZXDimension;

@interface ADSZXDataMatrixEncoderContext : NSObject
...
@property (nonatomic, assign) ADSZXDataMatrixSymbolShapeHint symbolShape;
@property (nonatomic, strong) ADSZXDataMatrixSymbolInfo *symbolInfo;

- (id)initWithMessage:(NSString *)msg;
- (void)setSizeConstraints:(ADSZXDimension *)minSize maxSize:(ADSZXDimension *)maxSize;

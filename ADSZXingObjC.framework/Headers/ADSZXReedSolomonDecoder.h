...
@class ADSZXGenericGF, ADSZXIntArray;
 ...
 */
@interface ADSZXReedSolomonDecoder : NSObject

- (id)initWithField:(ADSZXGenericGF *)field;
 ...
 */
- (BOOL)decode:(ADSZXIntArray *)received twoS:(int)twoS error:(NSError **)error;

 ...
 * annex S.
 */
@interface ADSZXDataMatrixHighLevelEncoder : NSObject
 ...
 * @return the encoded message (the char values range from 0 to 255)
 */
+ (NSString *)encodeHighLevel:(NSString *)msg shape:(ADSZXDataMatrixSymbolShapeHint)shape
                      minSize:(ADSZXDimension *)minSize maxSize:(ADSZXDimension *)maxSize;

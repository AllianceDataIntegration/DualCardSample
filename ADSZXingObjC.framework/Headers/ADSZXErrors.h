...
#define ADSZXErrorDomain @"ADSZXErrorDomain"
...
enum {
   ...
   */
  ADSZXReaderError       = 1004,

  /**
   * Covers the range of error which may occur when encoding a barcode using the Writer framework.
   */
  ADSZXWriterError       = 1005
};

// Helper methods for error instances
NSError *ADSZXChecksumErrorInstance(void);
NSError *ADSZXFormatErrorInstance(void);
NSError *ADSZXNotFoundErrorInstance(void);

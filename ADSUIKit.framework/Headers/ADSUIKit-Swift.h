...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ADSUIKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8ADSUIKit19ADSAgreementContext")
@interface ADSAgreementContext : ADSStandardContext
...
SWIFT_CLASS("_TtC8ADSUIKit26ADSAgreementViewController")
@interface ADSAgreementViewController : UIViewController <UIWebViewDelegate>
...
SWIFT_CLASS("_TtC8ADSUIKit14ADSUIKitPlugin")
@interface ADSUIKitPlugin : ADSStandardPlugin
...
SWIFT_CLASS("_TtC8ADSUIKit24ADSWebViewViewController")
@interface ADSWebViewViewController : UIViewController
@property (nonatomic, copy) NSString * _Nullable analyticPageName;
@property (nonatomic, copy) NSString * _Nullable descriptivePageName;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;

/*
 * Copyright 2006 Jeremias Maerki in part, and ADSZXing Authors in part
 *
...
@class ADSZXPDF417BarcodeMatrix, ADSZXIntArray;

/**
 * Top-level class for the logic part of the PDF417 implementation.
 */
@interface ADSZXPDF417 : NSObject

@property (nonatomic, strong, readonly) ADSZXPDF417BarcodeMatrix *barcodeMatrix;
@property (nonatomic, assign) BOOL compact;
@property (nonatomic, assign) ADSZXPDF417Compaction compaction;
 ...
 */
- (ADSZXIntArray *)determineDimensions:(int)sourceCodeWords errorCorrectionCodeWords:(int)errorCorrectionCodeWords error:(NSError **)error;

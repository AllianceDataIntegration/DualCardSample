 ...
 */
@interface ADSZXDataMatrixECBlocks : NSObject
 ...
 */
@interface ADSZXDataMatrixECB : NSObject
 ...
 */
@interface ADSZXDataMatrixVersion : NSObject

@property (nonatomic, strong, readonly) ADSZXDataMatrixECBlocks *ecBlocks;
 ...
 */
+ (ADSZXDataMatrixVersion *)versionForDimensions:(int)numRows numColumns:(int)numColumns;

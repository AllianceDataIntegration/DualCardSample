...
@class ADSZXBitMatrix, ADSZXDecoderResult, ADSZXReedSolomonDecoder;
 ...
 */
@interface ADSZXDataMatrixDecoder : NSObject
 ...
 */
- (ADSZXDecoderResult *)decode:(NSArray *)image error:(NSError **)error;
 ...
 * @return nil if error correction fails
 */
- (ADSZXDecoderResult *)decodeMatrix:(ADSZXBitMatrix *)bits error:(NSError **)error;

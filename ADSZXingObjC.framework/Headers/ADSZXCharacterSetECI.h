 ...
 * of ISO 18004.
 */
@interface ADSZXCharacterSetECI : NSObject
 ...
 *   unsupported
 */
+ (ADSZXCharacterSetECI *)characterSetECIByValue:(int)value;
 ...
 *   but unsupported
 */
+ (ADSZXCharacterSetECI *)characterSetECIByEncoding:(NSStringEncoding)encoding;

...
#import "ADSFSCalendar.h"
#import "ADSFSCalendarEventIndicator.h"

@interface ADSFSCalendarCell : UICollectionViewCell

@property (weak, nonatomic) ADSFSCalendar *calendar;
@property (weak, nonatomic) ADSFSCalendarAppearance *appearance;
...
@property (weak, nonatomic) ADSFSCalendarEventIndicator *eventIndicator;
...
@property (assign, nonatomic) ADSFSCalendarCellShape preferredCellShape;

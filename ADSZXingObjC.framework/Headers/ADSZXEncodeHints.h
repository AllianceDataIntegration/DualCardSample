 ...
 */
typedef enum {
  ADSZXDataMatrixSymbolShapeHintForceNone,
  ADSZXDataMatrixSymbolShapeHintForceSquare,
  ADSZXDataMatrixSymbolShapeHintForceRectangle
} ADSZXDataMatrixSymbolShapeHint;

typedef enum {
  ADSZXPDF417CompactionAuto,
  ADSZXPDF417CompactionText,
  ADSZXPDF417CompactionByte,
  ADSZXPDF417CompactionNumeric
} ADSZXPDF417Compaction;

@class ADSZXDimension, ADSZXPDF417Dimensions, ADSZXQRCodeErrorCorrectionLevel;

/**
 * These are a set of hints that you may pass to Writers to specify their behavior.
 */
@interface ADSZXEncodeHints : NSObject
 ...
 */
@property (nonatomic, assign) ADSZXDataMatrixSymbolShapeHint dataMatrixShape;

/**
 * Specifies a minimum barcode size. Only applicable to Data Matrix now.
 */
@property (nonatomic, strong) ADSZXDimension *minSize;

/**
 * Specifies a maximum barcode size. Only applicable to Data Matrix now.
 */
@property (nonatomic, strong) ADSZXDimension *maxSize;
 ...
 */
@property (nonatomic, strong) ADSZXQRCodeErrorCorrectionLevel *errorCorrectionLevel;
 ...
 */
@property (nonatomic, assign) ADSZXPDF417Compaction pdf417Compaction;

/**
 * Specifies the minimum and maximum number of rows and columns for PDF417.
 */
@property (nonatomic, strong) ADSZXPDF417Dimensions *pdf417Dimensions;
